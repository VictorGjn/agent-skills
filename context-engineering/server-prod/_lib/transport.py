    ...
    "ce_pack_context": {
        ...
        "properties": {
            ...
            "rerank": {"type": ["string", "null"], "enum": ["mmr", None], "default": None,
                       "description": "Optional rerank step. 'mmr' = Maximal Marginal Relevance (lambda=0.7) on top of semantic results."},
        },
        "required": ["query"],
    ...
    "ce_find_relevant_files": {
        ...
        "properties": {
            ...
            "task": {"type": ["string", "null"],
                     ...
                     "default": None},
            "rerank": {"type": ["string", "null"], "enum": ["mmr", None], "default": None,
                       "description": "Optional rerank. 'mmr' applies Maximal Marginal Relevance (lambda=0.7) to semantic results."},
        },
        "required": ["query"],
        "additionalProperties": False,
    },
